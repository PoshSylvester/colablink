...
"""
    ...
    init_parser.add_argument('config', help='Connection config JSON string from Colab output')
    init_parser.add_argument('--mount-dir', default='./colab-workspace', help='Local directory to mount Colab files (default: ./colab-workspace)')
...
Output streams in real-time to your terminal.'''
    ...
    exec_parser.add_argument('cmd', nargs=argparse.REMAINDER, help='Command to execute on Colab')
  ...
  colablink forward 5000 --local-port 3000 # Custom mapping'''
    ...
    p.add_argument('--local-port', type=int, help='Local port (default: same as remote)')
  ...
  colablink upload model.py -d /content/models/'''
    ...
    p.add_argument('--destination', '-d', help='Remote destination path (default: /content/)')
    p.add_argument('--recursive', '-r', action='store_true', help='Force recursive mode')
  ...
  colablink download /content/data/ -d ./local_data/'''
    ...
    p.add_argument('--destination', '-d', help='Local destination path (default: current directory)')
    p.add_argument('--recursive', '-r', action='store_true', help='Force recursive mode')
  ...
  colablink sync -d /path/to/project'''
    ...
    p.add_argument('--directory', '-d', help='Directory to sync (default: current directory)')
